...
export function Navbar(){
    ...
    return (
    // keep navbar on the top
    <NavbarBs sticky="top" className= 'bg-light shadow-sm mb-3'>
        <Container>
            {/* setup links with reacter router */}
            ...
            {/* shopping cart button setup with added quantity from SCContext */}
            {cartQuantity > 0 && (
            <Button 
                onClick={openCart} 
